...
const GEN_FIELDS = ["plaque", "marque", "modele", "annee", "vin", "kilometrage", "groupe", "base", "responsable", "tracker_gps", "prochaine_maintenance", "prochaine_expertise"];
...
export default function GeneralTab({ vehicle, onSaved }) {
  ...
  return (
    <div className="space-y-5">
      ...
      testId="general-view"
      action={!readOnly && <Button variant="outline" size="sm" onClick={startEdit} data-testid="general-edit-btn" className="gap-1.5"><Pencil className="h-3.5 w-3.5" /> Modifier</Button>}
    >
